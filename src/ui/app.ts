...
export type Tool = 'cmd' | 'build' | 'sell' | 'place' | 'erase' | 'rally' | 'settle' | 'outpost' | 'upgrade' | 'absorb' | 'power' | 'cheat';
...
export interface App {
  ...
  tab: Tab;
  power: PowerKey | null;
  /** Armed command mode. One shot: it clears after the next tap. 'none' is the contextual default. */
