...
export function reset(map: MapDef, cfg?: Partial<WorldConfig>): World {
  ...
  return {
    ...
    regions: [],
    regionOf: null,
    rules: { town: true, ages: false, civilians: false, pace: 1, fog: false, upkeep: false, connection: false, garrison: false, unrest: false, materials: false, population: false, diplomacy: false, veterancy: false },
...
export function restore(s: Snapshot): World {
  ...
  return {
    ...
    rules: Object.assign({ town: false, ages: false, civilians: false, pace: 1, fog: false, upkeep: false, connection: false, garrison: false, unrest: false, materials: false, population: false, diplomacy: false, veterancy: false }, s.rules ?? {}),
