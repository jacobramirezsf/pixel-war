...
export const POWERS: Record<PowerKey, PowerDef> = {
  ...
  reinforce: { key: 'reinforce', name: 'REINFORCE', group: 'battle', cost: 70,  cd: 60,  r: 12, hint: 'Three line units appear where you point. Must be near your army or a settlement.', hotkey: 'G' },
  lightning: { key: 'lightning', name: 'LIGHTNING', group: 'battle', cost: 50,  cd: 35,  r: 14, hint: 'A bolt on the nearest enemy that leaps to four more. Best on a crowd.', hotkey: 'Y' },
  meteor:    { key: 'meteor',    name: 'METEOR',    group: 'battle', cost: 120, cd: 90,  r: 30, hint: 'A warning circle, three seconds, then the sky falls. Units and buildings alike.', hotkey: 'U' },
  quake:     { key: 'quake',     name: 'QUAKE',     group: 'battle', cost: 90,  cd: 75,  r: 34, hint: 'The ground shakes. Stone walls and towers fall, steel bends, units stagger.', hotkey: 'I' },
  ...
  summon:    { key: 'summon',    name: 'SUMMON',    group: 'battle', cost: 150, cd: 90,  r: 14, hint: 'Three of your finest appear where you point. Near your army or a settlement.', hotkey: 'L' },
  rebuild:   { key: 'rebuild',   name: 'REBUILD',   group: 'realm',  cost: 60,  cd: 50,  r: 26, hint: 'Damaged buildings, walls, and towers there are made whole. Rubble stays rubble.', hotkey: 'J' },
  sanctuary: { key: 'sanctuary', name: 'SANCTUARY', group: 'realm',  cost: 50,  cd: 70,  r: 40, hint: 'For twenty seconds villagers there cannot be harmed and stay at work; your units stand firmer.', hotkey: 'N', realm: true },
  golden:    { key: 'golden',    name: 'GOLDEN AGE', group: 'realm', cost: 100, cd: 120, r: 60, hint: 'A town there earns double, grows faster, and builds faster for forty seconds.', hotkey: 'M', realm: true },
