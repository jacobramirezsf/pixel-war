...
export const BLD: Record<BldKey, BldDef> = {
  ...
  house:    { name: 'HOUSE',       cost: 40,  hp: 150, kind: 'town', group: 'economy', w: 2, h: 2, age: 0, buildT: 15, pop: 5, town: true, hint: 'Room for five more units.' },
  ...
  smith:    { name: 'BLACKSMITH',  cost: 100, hp: 250, kind: 'town', group: 'economy', w: 2, h: 2, mat: 20, age: 1, buildT: 25, town: true, max: 1, hint: 'Research sharper blades, better bows, thicker armor.' },
  barracks: { name: 'BARRACKS',    cost: 80,  hp: 350, kind: 'town', group: 'military', w: 3, h: 2, age: 0, buildT: 25, trains: ['line'], town: true, hint: 'Trains line infantry.' },
